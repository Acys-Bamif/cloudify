...
jsAnimate(document.querySelectorAll(".services di"), 's-card-inview', 'animate-s-card');
jsAnimate(document.querySelectorAll(".feedback .name"), 'f-card-inview', 'animate-f-card');
jsAnimate(document.querySelectorAll(".greenHead"), 'g-card-inview', 'animate-g-card');